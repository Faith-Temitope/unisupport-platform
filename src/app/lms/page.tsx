...
import { ShieldCheck, Monitor, Clock, CheckCircle2, Lock, Globe, ShieldAlert } from "lucide-react";
...
export default function LMSPage() {
  const benefits = [
    { 
      ...
      desc: "Comprehensive research for discussion prompts and peer engagement.", 
      icon: <Monitor className="text-emerald-600" size={28} /> 
    },
    { 
      title: "Assessment Prep", 
      desc: "Strategic preparation and management of module milestones.", 
      icon: <CheckCircle2 className="text-emerald-600" size={28} /> 
    },
    { 
      title: "Performance Audit", 
      desc: "Continuous grade tracking to ensure you stay on your target path.", 
      icon: <ShieldCheck className="text-emerald-600" size={28} /> 
    },
    { 
      title: "Timeline Guard", 
      desc: "Proactive scheduling to ensure every module is addressed early.", 
  ...
  return (
    <main className="bg-white">
      ...
      <div className="bg-gray-900 text-[9px] font-black text-center py-2 text-gray-500 uppercase tracking-[0.3em]">
        Strictly for Educational Assistance & Virtual Research Support
      </div>
        ...
        <section className="py-24 px-4 text-center max-w-5xl mx-auto">
          <div className="flex justify-center mb-8">
            <div className="bg-emerald-50 text-emerald-700 px-6 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.2em] flex items-center gap-2 border border-emerald-100">
              <Lock size={14} /> Encrypted Executive Portal Management
            </div>
          </div>
          <h1 className="text-5xl md:text-8xl font-black text-gray-900 mb-8 tracking-tighter uppercase italic leading-[0.85]">
            Virtual <span className="text-emerald-600">LMS & Portal</span> <br /> Concierge
          </h1>
          <p className="text-xl text-gray-500 leading-relaxed max-w-2xl mx-auto font-medium italic">
            Focus on your professional growth while we manage the administrative weight 
            of your digital learning environment.
          </p>
      ...
      <section className="py-24 bg-gray-50/50 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
                <h2 className="text-3xl font-black uppercase italic tracking-tighter">Stealth Academic Support</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            <h2 className="text-5xl md:text-6xl font-black mb-10 tracking-tighter uppercase italic leading-none">
                Safety <span className="text-emerald-600">First.</span>
            </h2>
            <div className="space-y-10">
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="font-black text-xl mb-2 uppercase italic tracking-tight">Zero-Knowledge Storage</h4>
                  <p className="text-gray-500 font-medium">Your credentials stay in a hardware-encrypted vault. Even our server admins cannot read them in plain text.</p>
                </div>
              </div>
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="font-black text-xl mb-2 uppercase italic tracking-tight">Geo-Matched IP Masks</h4>
                  <p className="text-gray-500 font-medium">Our experts connect via residential proxies located in your specific region to prevent automated security flags.</p>
                </div>
              </div>
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="font-black text-xl mb-2 uppercase italic tracking-tight">Human-Like Engagement</h4>
                  <p className="text-gray-500 font-medium">We mirror your natural login patterns and typing cadence to maintain a completely organic portal footprint.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-900 rounded-[4rem] p-12 md:p-16 text-white relative overflow-hidden shadow-3xl shadow-emerald-900/20">
            <div className="relative z-10">
                <div className="flex items-center gap-2 text-emerald-400 mb-6">
                    <ShieldAlert size={18} />
                    <span className="text-[10px] font-black uppercase tracking-[0.3em]">Privacy Guaranteed</span>
                </div>
                <h3 className="text-4xl font-black mb-8 uppercase italic tracking-tighter">Retainer Model</h3>
                <p className="mb-10 text-gray-400 font-medium text-lg leading-relaxed">Quotes are generated after a portal audit to assess module complexity.</p>
                
                <div className="space-y-6 mb-12">
                    <div className="flex justify-between border-b border-gray-800 pb-4 items-center">
                        <span className="font-bold text-gray-300">Bi-Weekly Retainer</span>
                        <span className="font-black text-xl italic text-emerald-400">Custom</span>
                    </div>
                    <div className="flex justify-between border-b border-gray-800 pb-4 items-center">
                        <span className="font-bold text-gray-300">Full Academic Term</span>
                        <div className="text-right">
                            <span className="block font-black text-emerald-400 italic">BUNDLE DISCOUNT</span>
                            <span className="text-[9px] text-gray-500 font-black uppercase">Stealth Protection Incl.</span>
                        </div>
                    </div>
                </div>
